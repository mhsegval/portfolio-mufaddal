...
<footer className="bg-white text-center">
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">Site developed and maintained by © <a target="_blank" href="https://www.linkedin.com/in/mohammed-segval-466069162/" class="hover:underline">Mohammed Segval</a>
        </span>
        <div className="flex justify-around m-4 space-x-6 text-center pb-10">
